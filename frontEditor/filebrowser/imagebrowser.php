...
<body id="imagebrowser">
								...
								<tr class="All images">
									<td>
											...
											<img style="width:60px;height:60px;object-fit: cover"
												src="<?php echo $SITEURL . 'data/uploads/' . $subPath . $upload['name']; ?>" onclick="selectImage(`<?php echo $SITEURL . 'data/uploads/' . $subPath . $upload['name']; ?>`)" />
    ...
    function selectImage(url) {
      window.opener.postMessage({ url: url }, window.location.origin);
    }
  </script>
</body>
